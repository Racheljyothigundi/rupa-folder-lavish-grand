...
import { t as Route } from "./account-9qhchClO.js";
import { a as TabsList, c as DialogContent, f as Button, i as TabsContent, l as DialogHeader, o as TabsTrigger, r as Tabs, s as Dialog, t as SiteLayout, u as DialogTitle } from "./SiteLayout-Bu9JhwBf.js";
...
function Account() {
	...
	return /* @__PURE__ */ jsxs(SiteLayout, { children: [
										...
										!ordersLoading && orders.map((o) => /* @__PURE__ */ jsxs("tr", { children: [
											...
											/* @__PURE__ */ jsxs("td", {
												...
												children: [/* @__PURE__ */ jsx("div", {
													...
													children: [o.items?.[0]?.item_name ?? "Order items", (o.items?.length ?? 0) > 1 ? ` + ${(o.items?.length ?? 1) - 1} more` : ""]
												})]
											}),
											/* @__PURE__ */ jsxs("td", {
		...
		/* @__PURE__ */ jsx(Dialog, {
			...
			onOpenChange: (open) => !open && setTrackedOrder(null),
			children: /* @__PURE__ */ jsx(DialogContent, {
				className: "max-w-2xl",
				children: trackedOrder && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsxs(DialogTitle, {
					className: "font-display text-2xl text-brand-deep",
					children: ["Track ", trackedOrder.order_number]
				}) }), /* @__PURE__ */ jsxs("div", {
					className: "space-y-5",
					children: [
						/* @__PURE__ */ jsx("div", {
							...
							children: [
								...
								return /* @__PURE__ */ jsxs("div", {
									className: `rounded-xl border p-3 ${complete ? "border-brand bg-brand/5" : "border-border bg-secondary/40"}`,
									children: [/* @__PURE__ */ jsx("div", { className: `w-3 h-3 rounded-full mb-2 ${complete ? "bg-brand" : "bg-muted-foreground/30"}` }), /* @__PURE__ */ jsx("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("div", {
										...
										className: "font-semibold capitalize",
										children: trackedOrder.payment_status
									})]
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "rounded-xl border border-border p-3",
									children: [/* @__PURE__ */ jsx("div", {
										...
										className: "font-semibold",
										children: trackedOrder.shipping_cost ? inr(Number(trackedOrder.shipping_cost)) : "Free"
									})]
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "rounded-xl border border-border p-3",
									children: [/* @__PURE__ */ jsx("div", {
										...
										className: "font-semibold",
										children: trackedOrder.status === "refunded" ? "Refunded" : trackedOrder.status === "cancelled" ? "Eligible for review" : "No refund requested"
									})]
								})
							]
						}),
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
							className: "font-semibold text-brand-deep mb-2",
							children: "Ordered items"
						}), /* @__PURE__ */ jsxs("div", {
							className: "rounded-xl border border-border divide-y overflow-hidden",
							children: [(trackedOrder.items ?? []).map((item) => /* @__PURE__ */ jsxs("div", {
								className: "grid grid-cols-[1fr_auto] gap-4 p-3 text-sm",
							...
							}, item.id)), !trackedOrder.items?.length && /* @__PURE__ */ jsx("div", {
								className: "p-3 text-sm text-muted-foreground",
								children: "Items are still syncing for this order."
							})]
						})] }),
						/* @__PURE__ */ jsx("div", {
							className: "rounded-xl bg-secondary p-3 text-sm text-muted-foreground",
							children: trackedOrder.notes ? trackedOrder.notes : "Refunds are tracked when the order is cancelled or marked refunded by the admin. For paid orders, the final refund depends on payment verification and business approval."
						})
					]
				})] })
			})
