...
import { n as getFreeDeliveryShortfall, t as getDeliveryCharge } from "./shipping-YP6RYrv7.js";
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							freeDeliveryShortfall > 0 && /* @__PURE__ */ jsxs("div", {
								className: "text-xs text-amber-700 bg-amber-50 rounded-lg p-2",
								children: [
									"Add ",
									inr(freeDeliveryShortfall),
